...
class PrivateVaultMainView extends StatelessWidget {
  const PrivateVaultMainView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(PrivateVaultMainController());
  ...
  Widget _buildTab(
    String title,
    int index,
    PrivateVaultMainController controller,
  ) {
    return Obx(
      () => GestureDetector(
  ...
  Widget _buildContentForTab(PrivateVaultMainController controller) {
  ...
  Widget _buildPhotosContent(PrivateVaultMainController controller) {
  ...
  Widget _buildVideosContent(PrivateVaultMainController controller) {
  ...
  Widget _buildDocumentsContent(PrivateVaultMainController controller) {
  ...
  Widget _buildSelectAllOption(PrivateVaultMainController controller) {
    return Obx(
      () => GestureDetector(
  ...
  Widget _buildBottomActionBar(PrivateVaultMainController controller) {
    if (controller.isSelectionMode.value) {
